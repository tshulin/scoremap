...
var i = (e, a) => `<span part="${a}">${e.reduce((l2, f3) => l2 + b(f3), "")}</span>`;
...
function z(n2, t2, e, i3) {
  ...
  for (const l2 of s2) {
    ...
    h2 === "integer" ? (m2 = true, a.push(...l2.value.split("").map((_2) => ({ type: h2, value: parseInt(_2) })))) : h2 === "group" ? a.push({ type: h2, value: l2.value }) : h2 === "decimal" ? (g2 = true, r3.push({ type: h2, value: l2.value, key: p2(h2) })) : h2 === "fraction" ? r3.push(...l2.value.split("").map((_2) => ({
      type: h2,
      value: parseInt(_2),
      key: p2(h2),
      pos: -1 - c2[h2]
