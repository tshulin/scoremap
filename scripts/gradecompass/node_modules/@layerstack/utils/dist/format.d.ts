...
export declare function format(value: number, format?: FormatNumberStyle | CustomFormatter, options?: FormatNumberOptions, locale?: string): string;
export declare function format(value: number, config: {
    type: FormatNumberStyle | CustomFormatter;
    options?: FormatNumberOptions;
    locale?: string;
}): string;
export declare function format(value: string | Date, format?: PeriodType | PeriodTypeCode | CustomFormatter, options?: FormatDateOptions, locale?: string): string;
