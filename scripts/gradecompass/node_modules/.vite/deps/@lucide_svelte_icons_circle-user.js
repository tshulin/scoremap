...
import {
  ...
  spread_props,
  wrap_snippet
} from "./chunk-WGUQYO6P.js";
import {
  append,
  comment
} from "./chunk-RERIWFPW.js";
import {
  FILENAME,
  HMR,
  add_svelte_meta,
...
function Circle_user($$anchor, $$props) {
  ...
  add_svelte_meta(
    () => (
      ...
      *
      */
      Icon_default(node, spread_props({ name: "circle-user" }, () => props, {
        get iconNode() {
          return iconNode;
        },
        children: wrap_snippet(Circle_user, ($$anchor2, $$slotProps) => {
          ...
          add_svelte_meta(() => snippet(node_1, () => $$props.children ?? noop), "render", Circle_user, 62, 2);
...
//# sourceMappingURL=@lucide_svelte_icons_circle-user.js.map
