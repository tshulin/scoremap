...
import { courseGrade, gradePercentage, gradesMatch, markGrade } from './grade';
...
describe('courseGrade - weighted', () => {
	...
	it('ignores assignments in categories the sample does not weight', () => {
		const grade = courseGrade(
	...
	// The weights table and the assignment Type cells are separate inputs
...
describe('gradesMatch', () => {
	...
	it('compares only to the precision the sample displays', () => {
