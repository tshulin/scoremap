...
describe('hiddenPoints', () => {
	it('finds points the sample counts but does not itemize', () => {
...
describe('withHiddenAssignments', () => {
	// The motivating case: the sample grades Tests 8/10 (50%) and
	...
	it('reconciles the computed grade with stored category totals', () => {
		const categories = [
