 ...
 * tab; attachments are generated from fictional fixtures and open in the
 * browser's viewer, same flow as Documents. Keeps the app
...
function MailDetail() {
  ...
  // A list entry may omit its body, so it is read from the bundled fixture on
  // open. `loaded` holds that message.
