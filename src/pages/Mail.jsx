 ...
 *
 * The list comes from the bundled demo snapshot. meta.mail tells the page
 * whether the mailbox is sample data or failed to load.
 *
 ...
 * a sender. Both work on subjects and senders. Clicking a message opens the reader
 * at /mail/:mailId.
 */
...
//
// There is deliberately no inline body preview. The body is read only when the
// visitor opens a fictional message.
