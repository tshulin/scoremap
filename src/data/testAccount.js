// Built-in fictional test dataset for exercising the interface. It is
// available in every build and never makes a network request.
//
...
const CALCULUS = {
  ...
  period: '1',
  room: 'B-210',
  staff: teacher('K. Nakamura', 'knakamura@example.edu'),
  marks: [
    {
      name: 'Quarter 1',
      shortName: 'Q1',
...
const ENGLISH = {
  ...
  period: '2',
  room: 'L-104',
  staff: teacher('D. Whitfield', 'dwhitfield@example.edu'),
  marks: [
    {
      name: 'Quarter 1',
      shortName: 'Q1',
...
const CHEMISTRY = {
  ...
  period: '3',
  room: 'S-215',
  staff: teacher('P. Vasquez', 'pvasquez@example.edu'),
  marks: [
    {
      name: 'Quarter 1',
      shortName: 'Q1',
...
const HISTORY = {
  ...
  period: '4',
  room: 'H-112',
  staff: teacher('M. Adeyemi', 'madeyemi@example.edu'),
  marks: [
    {
      name: 'Quarter 1',
      shortName: 'Q1',
...
// Fictional messages used only to exercise the demo mailbox UI.
export const TEST_MAIL = [
  {
    id: 'm1',
    subject: 'Course feedback survey',
    sender: { name: 'Avery Morgan', role: 'Teacher', email: 'amorgan@example.edu' },
    date: '2025-05-13',
    body: [
      'Hi all,',
      'Please complete the end-of-term course survey by Friday. Your feedback helps improve next year\'s class.',
      'Regards,\nA. Morgan',
    ],
    links: [{ label: 'Course survey', url: 'https://example.com/course-survey' }],
    attachments: [],
  },
  {
    id: 'm2',
    subject: 'End-of-year enrollment reminder',
    sender: { name: 'Riley Chen', role: 'Staff', email: 'rchen@example.edu' },
    date: '2025-05-07',
    body: [
      'Families,',
      'If your student will not be returning to Example Academy next year, please let the office know so enrollment records can be updated.',
      'Thank you,\nR. Chen',
    ],
    links: [
  ...
  {
    id: 'm3',
    subject: 'Summer learning opportunities',
    sender: { name: 'Jordan Patel', role: 'Staff', email: 'jpatel@example.edu' },
    date: '2025-04-28',
    body: [
      'Hello students,',
    ...
    links: [
      ...
      { label: 'Volunteer Information', url: 'https://example.com/volunteer' },
  ...
  {
    id: 'm4',
    subject: 'More summer enrichment opportunities',
    sender: { name: 'Jordan Patel', role: 'Staff', email: 'jpatel@example.edu' },
    date: '2025-04-22',
    body: [
      'Hello students,',
  ...
  {
    id: 'm5',
    subject: 'Volunteers needed for school events',
    sender: { name: 'Jordan Patel', role: 'Staff', email: 'jpatel@example.edu' },
    date: '2025-04-17',
    body: [
      'Hi everyone,',
  ...
  {
    id: 'm6',
    subject: 'New community volunteer opportunities',
    sender: { name: 'Jordan Patel', role: 'Staff', email: 'jpatel@example.edu' },
    date: '2025-04-15',
    body: [
      'Hi everyone,',
  ...
  {
    id: 'm7',
    subject: 'College fair tomorrow at lunch',
    sender: { name: 'Jordan Patel', role: 'Staff', email: 'jpatel@example.edu' },
    date: '2025-04-14',
    body: [
      'Students,',
      'A college fair will be held tomorrow during lunch at Example Academy. Stop by to meet admissions representatives. A sample list is attached.',
      'Best,\nJ. Patel',
    ],
    links: [],
...
// ---- document downloads ----
// Demo documents are generated here as
