// Built-in fictional display dataset used by the landing-page demo.
//
...
// placeholder banners (see sync.js displaySnapshot).
//
// Mail and documents are invented for this fictional school.
//
...
const CALCULUS = {
  ...
  period: '1',
  room: 'B-204',
  staff: teacher('R. Okafor', 'rokafor@example.edu'),
  marks: [
    {
      name: 'Quarter 1',
      shortName: 'Q1',
...
const ENGLISH = {
  ...
  period: '2',
  room: 'L-117',
  staff: teacher('S. Marchetti', 'smarchetti@example.edu'),
  marks: [
    {
      name: 'Quarter 1',
      shortName: 'Q1',
...
const HISTORY = {
  ...
  period: '3',
  room: 'H-121',
  staff: teacher('L. Thibodeau', 'lthibodeau@example.edu'),
  marks: [
    {
      name: 'Quarter 1',
      shortName: 'Q1',
...
const CHEMISTRY = {
  ...
  period: '4',
  room: 'S-209',
  staff: teacher('E. Brandt', 'ebrandt@example.edu'),
  marks: [
    {
      name: 'Quarter 1',
      shortName: 'Q1',
...
const SPANISH = {
  ...
  period: '5',
  room: 'W-306',
  staff: teacher('M. Arellano', 'marellano@example.edu'),
  marks: [
    {
      name: 'Quarter 1',
      shortName: 'Q1',
...
const COMPSCI = {
  ...
  period: '6',
  room: 'T-112',
  staff: teacher('P. Sandoval', 'psandoval@example.edu'),
  marks: [
    {
      name: 'Quarter 1',
      shortName: 'Q1',
...
export const DISPLAY_MAIL = [
  {
    ...
    sender: { name: 'E. Brandt', role: 'Teacher', email: 'ebrandt@example.edu' },
    date: '2026-10-14',
    body: [
      'Chemistry students,',
  ...
  },
  {
    ...
    sender: { name: 'D. Whitmore', role: 'Counselor', email: 'dwhitmore@example.edu' },
    date: '2026-10-12',
    body: [
      'Juniors,',
  ...
  },
  {
    ...
    sender: { name: 'K. Ellison', role: 'Staff', email: 'kellison@example.edu' },
    date: '2026-10-08',
    body: [
  ...
  },
  {
    ...
    body: [
      'AP students,',
      'Registration for May AP exams is open through November 6. Use the information page below - the fall deadline matters, late registration adds a fee. The attached guide covers costs, fee waivers, and how to join your class sections on College Board.',
      'Ms. Whitmore\nCounseling Office',
    ],
    links: [
      { label: 'AP Registration Information', url: 'https://example.com/ap-registration' },
  ...
  },
  {
    ...
    sender: { name: 'S. Marchetti', role: 'Teacher', email: 'smarchetti@example.edu' },
    date: '2026-09-25',
    body: [
      'Hi everyone,',
  ...
  },
  {
    ...
    sender: { name: 'J. Paredes', role: 'Staff', email: 'jparedes@example.edu' },
    date: '2026-09-10',
    body: [
      'Hello students,',
  ...
  },
  {
    ...
    sender: { name: 'R. Okafor', role: 'Teacher', email: 'rokafor@example.edu' },
    date: '2026-08-17',
    body: [
